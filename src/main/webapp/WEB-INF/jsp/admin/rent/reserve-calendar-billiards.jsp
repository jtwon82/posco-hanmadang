				...
				<div id="page-inner">
					...
					<article class="container-body">
						...
						<div class="calendar-by-3">
							...
							<div class="rent-tabs ">
								<a href="/mgr/rent/reserve/time/15?date=<c:out value="${date}"/>" class="by-3"><span>주경기장(배드민턴)</span></a>
								<a href="/mgr/rent/reserve/time/16?date=<c:out value="${date}"/>" class="by-3"><span>탁구장</span></a>
								<a href="/mgr/rent/reserve/time/17?date=<c:out value="${date}"/>" class="by-3 is-selected"><span>당구장</span></a>
							</div>
						</div>
						<div class="calendar-by-3">
							...
							<div class="rent-tabs ">
								...
								<a href="/mgr/rent/reserve/lecture" class="by-4"><span>고정강좌 취소</span></a>
							</div>
						</div>
