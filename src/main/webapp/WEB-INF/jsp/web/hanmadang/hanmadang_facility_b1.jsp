		...
		<div id="contents-inner">
			...
			<article class="container">
				<div class="floor-tabs">
					...
					<a href="#none" class="by-4 is-selected"><span>B1</span></a>
				</div>

				<div class="floor-cnt">
					<div class="floor-state">
						<strong>B1</strong>
						<span class="eng">Basement</span>
						<ul class="floor-list">
							<li>탁구장</li>
							<li>당구장</li>
							<li>주차장</li>
						...
						<a href="#floor-b1" class="btn btn-floor btn-level2 js-modal__btn-open">이미지보기</a>
					</div>
					<div class="floor-img"><img src="/web/assets/img/floor-b1.jpg" alt="한마당" /></div>
				</div>
			</article>
		</div>
		
		<div class="modal-basic js-modal " id="floor-b1"><!-- layer 제어는 .is-expanded -->
							...
							<div class="floor-img">
								<div class="slide-wrap">
									<div class="slide-frame" id="slide-floor">
										<ul class="clearfix">
											<li><img src="/web/assets/img/floor-b1-01.jpg" alt="한마당" /></li>
											<li><img src="/web/assets/img/floor-b1-02.jpg" alt="한마당" /></li>
											<li><img src="/web/assets/img/floor-b1-03.jpg" alt="한마당" /></li>
											<li><img src="/web/assets/img/floor-b1-04.jpg" alt="한마당" /></li>
											<li><img src="/web/assets/img/floor-b1-05.jpg" alt="한마당" /></li>
											<li><img src="/web/assets/img/floor-b1-06.jpg" alt="한마당" /></li>
											<li><img src="/web/assets/img/floor-b1-07.jpg" alt="한마당" /></li>
											<li><img src="/web/assets/img/floor-b1-08.jpg" alt="한마당" /></li>
											<li><img src="/web/assets/img/floor-b1-09.jpg" alt="한마당" /></li>
										</ul>
									</div>
