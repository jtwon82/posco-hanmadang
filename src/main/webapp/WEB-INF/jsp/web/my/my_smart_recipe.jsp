	...
	<main id="contents" role="main">
		<div id="contents-inner">
			...
			<article class="container">
				<div class="contents-title cl-my">맞춤 운동 처방</div>
				<div class="smart-caloly"><span class="cl-my">홍길동</span> 회원님의 오늘 유산소 처방 칼로리는 <strong class="cl-my">000 Kcal</strong>입니다.</div>

				<div class="smart-caloly-view">
					...
					<div class="table-basic table-basic-type3 line-box">
						<table>
							<caption>칼로리 상세에 대한 정보제공</caption>
							<colgroup>
								<col width="*">
								<col width="110px">
								<col width="70px">
							...
							<tbody>
								<tr>
									<td class="col-left">처방 칼로리</td>
									<td><span class="cl-smart size-point">000</span></td>
									<td class="col-left">Kcal</td>
								</tr>
								<tr>
									<td class="col-left">처방 강도</td>
									<td><span class="cl-smart size-point">000</span></td>
									<td class="col-left">%</td>
								</tr>
								<tr>
									<td class="col-left">처방 심박수</td>
									<td><span class="cl-smart size-point">000</span></td>
									<td class="col-left">회/분</td>
								</tr>
								<tr>
									<td class="col-left">처방 속도</td>
									<td><span class="cl-smart size-point">000</span></td>
									<td class="col-left">㎞/h</td>
								</tr>
								<tr>
									<td class="col-left">처방 거리</td>
									<td><span class="cl-smart size-point">000</span></td>
									<td class="col-left">㎞</td>
								</tr>
								<tr>
									<td class="col-left">처방 시간</td>
									<td><span class="cl-smart size-point">000</span></td>
									<td class="col-left">분</td>
								</tr>
							</tbody>
						</table>
					</div>
