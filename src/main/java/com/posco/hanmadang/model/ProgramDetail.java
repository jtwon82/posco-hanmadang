...
public class ProgramDetail extends Vo{
	private String program_code;
    private String program_name;
    private String event_code;
    private String sumup_code;
    private String sales_code;
    private String month_qty;
	...
	public String getSumup_code() {
		return sumup_code;
	}
	public void setSumup_code(String sumup_code) {
		this.sumup_code = sumup_code;
	}
