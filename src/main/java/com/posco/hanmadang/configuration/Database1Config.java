...
@Configuration
@MapperScan(value="com.posco.hanmadang.mapper.posco", sqlSessionFactoryRef="db1SqlSessionFactory")
...
public class Database1Config {
    ...
    public SqlSessionFactory db1SqlSessionFactory(@Qualifier("db1DataSource") DataSource db1DataSource, ApplicationContext applicationContext) throws Exception {
        ...
        sqlSessionFactoryBean.setMapperLocations(applicationContext.getResources("classpath:mybatis/mapper/posco/*.xml"));
